...
import {CollectionPage} from './components/Category/CollectionPage.jsx';
...
import { ProductDetailPage } from "./components/Category/ProductDetailPage.jsx";
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/category/:category" element={<><HeaderWhite /><CollectionPage /></>} />
