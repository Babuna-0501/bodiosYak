...
export function VideoSection() {
  return (
    <div className="flex relative flex-col items-center px-16 pb-32 mt-14 w-full text-xl font-light text-white min-h-[1080px] pt-[912px] tracking-[6px] max-md:px-5 max-md:py-24 max-md:mt-10 max-md:max-w-full">
      <img
        loading="lazy"
      ...
      />
      <div className="flex relative flex-wrap gap-5 justify-center items-center mb-0 max-w-full w-[559px] max-md:mb-2.5">
